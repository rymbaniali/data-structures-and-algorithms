...
const toLastNames = people => {
  ...
  // Solution code here...
  let fullName = people.map(Element => {
...
const addValues = (arr) => {
  let arrSum = arr.reduce((accumelator, value) => {
    accumelator = accumelator + value;
    return accumelator;
  }, 0);
  return arrSum;
};
...
const addPurchases = (arr) => {
  ...
  let arrSum = arr.reduce((accumelator, value) => {
    accumelator = accumelator + value.purchasePrice;
    return accumelator;
  }, 0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let sumArr = arr.reduce((acc, val, idx) => {
    return idx + 1;
  }, 0);
  return sumArr;
};
